...
const CSHARP: Language = {
  ...
  firstSessionPrompt:
    ...
    'and note the workspace shape: file tree on the left, multi-tab editor, Run launches a real WPF window on their desktop, and a console-run button can run the active `.cs` file for non-GUI exercises. Send-to-tutor bundles the student note when present, open files, and recent process output. ' +
